...
export default function Cards(props) {
  ...
  if (!restart) {
    if (final.includes("erro")) {
      return (
        <Card>
          <h1 className="line erro" data-test="flashcard-text">
            Pergunta {index + 1}
          </h1>
      ...
      return (
        <Card>
          <h1 className="line quase" data-test="flashcard-text">
            Pergunta {index + 1}
          </h1>
      ...
      return (
        <Card>
          <h1 className="line certo" data-test="flashcard-text">
            Pergunta {index + 1}
          </h1>
